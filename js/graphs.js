...
function verticalGraph() {
    ...
    var margin = { top: mTop, right: mRight, bottom: mLeft, left: mBottom },
        width = wB * scaleFactor - margin.left - margin.right,
        height = wB - margin.top - margin.bottom;
...
function pieGraph() {
    ...
    // var color = d3.scaleOrdinal(["blue", "red", "cyan", "orange", "royalblue", "pink", "yellow"]);
